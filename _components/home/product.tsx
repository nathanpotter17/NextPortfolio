  ...
  return (
    <section className="flex flex-col items-center justify-center pt-5 pb-5">
      <div className="flex justify-between p-1 gap-2 border-2 border-gray50 rounded-lg">
        <p className="text-sm px-2 text-gray-500">NSP Product</p>
      </div>
      <div className="text-center">
        ...
        <p className="text-center max-w-[512px] mx-auto p-2 pb-8 text-lg text-tl">
          Enjoy NSP&apos;s hyper-optimized methodology that takes digital
          design, marketing, SEO and other strategies to their very core,
        ...
        {[...Array(6)].map((_, index) => (
          ...
          >
            ...
            <p className="text-md text-gray-500">
              {index === 0
                ? 'I make sure device targets are met with Quality UX.'
                : index === 1
                ? 'Libraries to choose from, or custom web components.'
                : index === 2
                ? 'NSP apps are powered by AWS, Resend, Hubspot, Stripe, etc.'
                : index === 3
