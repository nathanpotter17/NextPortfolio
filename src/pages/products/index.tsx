...
export default function Page() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col mx-auto text-center text-white z-0">
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-black pb-12 m-6">
        {products.map((product, i) => (
          ...
          >
            ...
            >
              <Image
                src={
                  product.images[0] !== null && product.images[0] !== undefined
                    ? product.images[0]
                    : 'home/notavail.svg'
                }
                width={242}
