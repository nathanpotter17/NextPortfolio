    ...
    <section className="flex flex-col items-center justify-center pt-5 pb-5">
      ...
      <div className="text-center">
        ...
        <p className="text-center max-w-[512px] mx-auto p-2 pb-8 text-lg text-tl">
          My hyper-optimized methodology takes digital design, marketing, SEO
          and other strategies to their very core, streamlining effectiveness.
        </p>
      </div>
          ...
          >
            ...
            <p className="text-md text-gray-500">
              {index === 0
                ...
                : index === 3
                ? "Don't rely on AI, 'no-code', or worry about customization ever again."
                : index === 4
